CREATE TABLE [MST].[MenuMaster_tracking] (
    ...
    CONSTRAINT [PK_MST.MenuMaster_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MST].[MenuMaster_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
