CREATE TABLE [MMS].[ModuleApp_tracking] (
    ...
    CONSTRAINT [PK_MMS.ModuleApp_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[ModuleApp_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
