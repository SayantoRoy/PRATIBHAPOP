CREATE TABLE [MMS].[SubModule_tracking] (
    ...
    CONSTRAINT [PK_MMS.SubModule_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[SubModule_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
