CREATE TABLE [MMS].[MenuFrame_tracking] (
    ...
    CONSTRAINT [PK_MMS.MenuFrame_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[MenuFrame_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
