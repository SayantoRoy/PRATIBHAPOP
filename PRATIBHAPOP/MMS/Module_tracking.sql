CREATE TABLE [MMS].[Module_tracking] (
    ...
    CONSTRAINT [PK_MMS.Module_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[Module_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
