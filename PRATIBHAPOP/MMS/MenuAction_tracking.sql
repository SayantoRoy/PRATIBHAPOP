CREATE TABLE [MMS].[MenuAction_tracking] (
    ...
    CONSTRAINT [PK_MMS.MenuAction_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[MenuAction_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
