CREATE TABLE [MMS].[MenuDetail_tracking] (
    ...
    CONSTRAINT [PK_MMS.MenuDetail_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[MenuDetail_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
