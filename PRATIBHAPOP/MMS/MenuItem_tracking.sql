CREATE TABLE [MMS].[MenuItem_tracking] (
    ...
    CONSTRAINT [PK_MMS.MenuItem_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[MenuItem_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
