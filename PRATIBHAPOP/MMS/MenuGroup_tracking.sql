CREATE TABLE [MMS].[MenuGroup_tracking] (
    ...
    CONSTRAINT [PK_MMS.MenuGroup_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [MMS].[MenuGroup_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
