CREATE TABLE [HKP].[CivilStatus_tracking] (
    ...
    CONSTRAINT [PK_HKP.CivilStatus_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [HKP].[CivilStatus_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
