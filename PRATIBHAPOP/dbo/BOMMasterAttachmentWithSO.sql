CREATE TABLE [dbo].[BOMMasterAttachmentWithSO] (
    ...
    [BOMMasterAttachmentWithItemId] VARCHAR (30) NULL,
    ...
    FOREIGN KEY ([BOMMasterAttachmentWithItemId]) REFERENCES [dbo].[BOMMasterAttachmentWithItem] ([Id]),
