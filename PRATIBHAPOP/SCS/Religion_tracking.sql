CREATE TABLE [SCS].[Religion_tracking] (
    ...
    CONSTRAINT [PK_SCS.Religion_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[Religion_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
