CREATE TABLE [SCS].[PostOffice_tracking] (
    ...
    CONSTRAINT [PK_SCS.PostOffice_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[PostOffice_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
