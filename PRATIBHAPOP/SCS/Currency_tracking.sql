CREATE TABLE [SCS].[Currency_tracking] (
    ...
    CONSTRAINT [PK_SCS.Currency_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[Currency_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
