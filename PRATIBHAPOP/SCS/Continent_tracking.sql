CREATE TABLE [SCS].[Continent_tracking] (
    ...
    CONSTRAINT [PK_SCS.Continent_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[Continent_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
