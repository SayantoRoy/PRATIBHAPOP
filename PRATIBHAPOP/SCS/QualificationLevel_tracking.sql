CREATE TABLE [SCS].[QualificationLevel_tracking] (
    ...
    CONSTRAINT [PK_SCS.QualificationLevel_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[QualificationLevel_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
