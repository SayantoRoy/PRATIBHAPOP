CREATE PROCEDURE [SCS].[State_bulkinsert]
...
(SELECT p.*, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [SCS].[State_tracking] t ON p.[Id] = t.[Id]) AS changes ON changes.[Id] = base.[Id]
