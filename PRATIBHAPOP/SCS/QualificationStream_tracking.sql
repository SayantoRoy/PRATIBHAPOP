CREATE TABLE [SCS].[QualificationStream_tracking] (
    ...
    CONSTRAINT [PK_SCS.QualificationStream_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[QualificationStream_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
