CREATE TABLE [SCS].[PoliceStation_tracking] (
    ...
    CONSTRAINT [PK_SCS.PoliceStation_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[PoliceStation_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
