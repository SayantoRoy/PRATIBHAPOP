CREATE TABLE [SCS].[UOMDimension_tracking] (
    ...
    CONSTRAINT [PK_SCS.UOMDimension_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[UOMDimension_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
