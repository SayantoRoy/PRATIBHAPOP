CREATE TABLE [SCS].[Country_tracking] (
    ...
    CONSTRAINT [PK_SCS.Country_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[Country_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
