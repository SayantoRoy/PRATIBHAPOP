CREATE TABLE [SCS].[Language_tracking] (
    ...
    CONSTRAINT [PK_SCS.Language_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[Language_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
