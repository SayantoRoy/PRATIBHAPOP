CREATE TABLE [SCS].[State_tracking] (
    ...
    CONSTRAINT [PK_SCS.State_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[State_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
