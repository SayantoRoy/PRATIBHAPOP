CREATE PROCEDURE [SCS].[Continent_bulkupdate]
...
(SELECT p.*, t.update_scope_local_id, t.scope_update_peer_key, t.local_update_peer_timestamp FROM @changeTable p LEFT JOIN [SCS].[Continent_tracking] t ON p.[Id] = t.[Id]) as changes ON changes.[Id] = base.[Id]
