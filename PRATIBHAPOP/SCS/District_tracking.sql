CREATE TABLE [SCS].[District_tracking] (
    ...
    CONSTRAINT [PK_SCS.District_tracking] PRIMARY KEY CLUSTERED ([Id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [local_update_peer_timestamp_index]
    ON [SCS].[District_tracking]([local_update_peer_timestamp] ASC, [Id] ASC);
